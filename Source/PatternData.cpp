...
CPatternData::CPatternData(unsigned int PatternLength)
    :                              // // //
      ...
      m_iPatternLength(PatternLength), m_iFrameCount(1),
      m_iSongSpeed(DEFAULT_SPEED), m_iSongTempo(DEFAULT_TEMPO_NTSC),
      m_bUseGroove(false),                // // //
      m_vRowHighlight(DEFAULT_HIGHLIGHT), // // //
      m_iFrameList(),                     // // //
      m_pPatternData(), m_iEffectColumns() {
...
bool CPatternData::IsCellFree(unsigned int Channel, unsigned int Pattern,
...
bool CPatternData::IsPatternEmpty(unsigned int Channel,
...
bool CPatternData::IsPatternInUse(unsigned int Channel,
                                  unsigned int Pattern) const {
...
stChanNote *CPatternData::GetPatternData(unsigned int Channel,
...
stChanNote *CPatternData::GetPatternData(unsigned int Channel,
                                         unsigned int Pattern,
                                         unsigned int Row) {
  if (!m_pPatternData[Channel][Pattern]) // Allocate pattern if accessed for the
                                         // first time
...
CString CPatternData::GetTitle() const { return m_sTrackName; }

unsigned int CPatternData::GetPatternLength() const { return m_iPatternLength; }

unsigned int CPatternData::GetFrameCount() const { return m_iFrameCount; }

unsigned int CPatternData::GetSongSpeed() const { return m_iSongSpeed; }

unsigned int CPatternData::GetSongTempo() const { return m_iSongTempo; }
...
void CPatternData::SetTitle(CString str) { m_sTrackName = str; }

void CPatternData::SetPatternLength(unsigned int Length) {
  m_iPatternLength = Length;
}

void CPatternData::SetFrameCount(unsigned int Count) { m_iFrameCount = Count; }

void CPatternData::SetSongSpeed(unsigned int Speed) { m_iSongSpeed = Speed; }

void CPatternData::SetSongTempo(unsigned int Tempo) { m_iSongTempo = Tempo; }
...
unsigned int CPatternData::GetFramePattern(unsigned int Frame,
                                           unsigned int Channel) const {
  return m_iFrameList[Frame][Channel];
}

void CPatternData::SetFramePattern(unsigned int Frame, unsigned int Channel,
                                   unsigned int Pattern) {
...
stHighlight CPatternData::GetRowHighlight() const { return m_vRowHighlight; }

void CPatternData::SwapChannels(unsigned int First,
                                unsigned int Second) // // //
{
