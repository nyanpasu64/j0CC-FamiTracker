...
CMainFrame::CMainFrame()
    : m_pVisualizerWnd(NULL), m_pFrameEditor(NULL), m_pGrooveDlg(NULL), // // //
      ...
      m_pBannerEditCopyright(NULL), m_pInstrumentList(NULL), m_history(NULL),
      m_iFrameEditorPos(FRAME_EDIT_POS_TOP), m_pInstrumentFileTree(NULL),
      m_iInstrument(0), m_iTrack(0), m_iOctave(3), m_iInstNumDigit(0), // // //
...
bool CMainFrame::CreateToolbars() {
  ...
  HBITMAP hbm = (HBITMAP)::LoadImage(
      AfxGetInstanceHandle(), MAKEINTRESOURCE(IDB_TOOLBAR_256), IMAGE_BITMAP,
      DPI::SX(352), DPI::SY(16), LR_CREATEDIBSECTION);
...
bool CMainFrame::CreateInstrumentToolbar() {
  ...
  // Set 24-bit icons
  HBITMAP hbm = (HBITMAP)::LoadImage(
      AfxGetInstanceHandle(), MAKEINTRESOURCE(IDB_TOOLBAR_INST_256),
      IMAGE_BITMAP, DPI::SX(96), DPI::SY(16), LR_CREATEDIBSECTION);
  m_bmInstToolbar.Attach(hbm);
  m_ilInstToolBar.Create(DPI::SX(16), DPI::SY(16), ILC_COLOR24 | ILC_MASK, 4,
                         4);
...
/** \brief Performs pAction, saves "before" and "after" into pAction, and adds
 * to history.
 */
