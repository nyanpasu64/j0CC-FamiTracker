...
/*!
        ...
        \details It manages all bookmark collections, and provides methods to
   synchronize with the document's tracks.
*/
...
public:
  ...
  */
  ...
  /*!	\brief Obtains a bookmark collection, and then releases ownership of the
     collection. \details Used in importing FTMs. \param Track The track index.
          \return Pointer to the bookmark collection.
  */
  ...
  */
  ...
  /*!	\brief Inserts a track at a given position, creating an empty collection
     for the new track. \details The bookmark manager always manages the same
     number of bookmark collections; the last collection will be deleted. \param
