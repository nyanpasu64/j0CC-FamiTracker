...
ON_EN_KILLFOCUS(IDC_EDIT_RECORDER_INTERVAL,
                &CRecordSettingsDlg::OnEnKillfocusEditRecorderInterval)
ON_EN_KILLFOCUS(IDC_EDIT_RECORDER_COUNT,
                &CRecordSettingsDlg::OnEnKillfocusEditRecorderCount)
END_MESSAGE_MAP()
