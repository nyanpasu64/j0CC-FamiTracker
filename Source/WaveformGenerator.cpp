...
CWavegenParam::CWavegenParam(wavegen_param_type_t Type, const char *Name)
    : m_iParamType(Type), m_pParamName(Name) {}

CWavegenParam::~CWavegenParam() {}

wavegen_param_type_t CWavegenParam::GetType() const { return m_iParamType; }

const char *CWavegenParam::GetName() const { return m_pParamName; }
...
CWavegenParamUnsigned::CWavegenParamUnsigned(const char *Name)
    : CWavegenParam(WGPARAM_UNSIGNED, Name), m_iData(0) {}

unsigned int CWavegenParamUnsigned::GetValue() const { return m_iData; }
...
CWavegenParamFloat::CWavegenParamFloat(const char *Name)
    : CWavegenParam(WGPARAM_FLOAT, Name), m_fData(0.f) {}

float CWavegenParamFloat::GetValue() const { return m_fData; }
...
CWavegenParamBoolean::CWavegenParamBoolean(const char *Name)
    : CWavegenParam(WGPARAM_BOOLEAN, Name), m_bData(false) {}

bool CWavegenParamBoolean::GetValue() const { return m_bData; }
...
const char *CWavegenParamString::GetValue() const { return m_pData.c_str(); }
