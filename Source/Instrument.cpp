...
CInstrument::CInstrument(inst_type_t type)
    : m_iType(type), m_pInstManager(nullptr) // // //
{
...
const char *CInstrument::GetName() const { return m_cName; }

void CInstrument::RegisterManager(
    CInstrumentManagerInterface *pManager) // // //
{
