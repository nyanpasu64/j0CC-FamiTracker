...
/*!
        \brief Specialization of the instrument sequence editor panel class for
   CSeqInstrument.
*/
...
public:
  CInstrumentEditorSeq(CWnd *pParent, TCHAR *Title, LPCTSTR *SeqName, int Vol,
                       int Duty, inst_type_t Type);
