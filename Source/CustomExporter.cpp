...
CCustomExporter::CCustomExporter(void)
    : m_name("CustomExporter"), m_ext(".asm"), m_dllFilePath(""),
      m_dllHandle(NULL), m_referenceCount(NULL), m_GetName(NULL),
      m_Export(NULL) {}
...
CCustomExporter::~CCustomExporter(void) { decReferenceCount(); }

CString const &CCustomExporter::getName(void) const { return m_name; }

CString const &CCustomExporter::getExt(void) const { return m_ext; }
...
bool CCustomExporter::load(CString FileName) {
  ...
  if (NULL != m_dllHandle) {
    m_GetExt =
        (const char *(__cdecl *)(void))GetProcAddress(m_dllHandle, "GetExt");
    ...
    m_GetName =
        (const char *(__cdecl *)(void))GetProcAddress(m_dllHandle, "GetName");
    ...
    m_Export =
        (bool(__cdecl *)(FamitrackerDocInterface const *iface,
                         const char *fileName))GetProcAddress(m_dllHandle,
                                                              "Export");
...
bool CCustomExporter::Export(CFamiTrackerDocInterface const *doc,
