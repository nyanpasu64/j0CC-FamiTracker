...
void CSettings::SetupSettings() {
  ...
  */
  ...
  SETTING_BOOL("General", "Retrieve channel state (on by default in j0CC)",
               true, &General.bRetrieveChanState);
  ...
  SETTING_INT("Appearance", "Pattern font size percentage", FONT_RATIO,
