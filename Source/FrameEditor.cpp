...
CFrameEditor::CFrameEditor(CMainFrame *pMainFrm)
    : m_pMainFrame(pMainFrm), m_pDocument(NULL), m_pView(NULL),
      mClipboardFormat(0), m_iWinWidth(0), m_iWinHeight(0), m_iHiglightLine(0),
      m_iFirstChannel(0), m_iCursorPos(0), m_iRowsVisible(0), m_iMiddleRow(0),
    ...
    if (Num != -1) {
      if (IsSelecting()) { // // //
        ...
        Action *pAction = m_pMainFrame->ChangeAllPatterns()
                              ? (Action *)new CFActionSetPatternAll{Pattern}
