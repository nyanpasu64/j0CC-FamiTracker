...
private:
  ...
  bool EditInstrumentColumn(stChanNote &Note, Keycode key, bool &StepDown,
                            bool &MoveRight, bool &MoveLeft);
  bool EditVolumeColumn(stChanNote &Note, Keycode key, bool &bStepDown);
  bool EditEffNumberColumn(stChanNote &Note, Input input, int EffectIndex,
                           bool &bStepDown);
  bool EditEffParamColumn(stChanNote &Note, Keycode key, int EffectIndex,
