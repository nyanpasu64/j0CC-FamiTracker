...
public:
  ...
  bool IsCellFree(unsigned int Channel, unsigned int Pattern,
  ...
  stChanNote *GetPatternData(unsigned int Channel, unsigned int Pattern,
                             unsigned int Row);
  ...
  void SetFramePattern(unsigned int Frame, unsigned int Channel,
