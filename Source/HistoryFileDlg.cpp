...
HistoryFileDlg::HistoryFileDlg(
    PATHS historyType,
    BOOL openNotSave, // TRUE for FileOpen, FALSE for FileSaveAs
    LPCTSTR defaultExt, LPCTSTR defaultName, DWORD dwFlags, LPCTSTR lpszFilter,
    CWnd *pParentWnd, DWORD dwSize, BOOL bVistaStyle)
...
//	ofn.lpstrInitialDir = theApp.GetSettings()->GetPath(pathType) +
//_T("\\"); 	ofn.Flags |= flags;
//
//
