...
static const unsigned char VRC7_SINE_PATCH[] = {0x01, 0x21, 0x00, 0x00, 0x00,
                                                0xF0, 0x00, 0x0F}; // // //

CInstrumentVRC7::CInstrumentVRC7()
    : CInstrument(INST_VRC7), m_iPatch(0) // // //
{
...
bool CInstrumentVRC7::Load(CDocumentFile *pDocFile) {
  m_iPatch = CModuleException::AssertRangeFmt(pDocFile->GetBlockInt(), 0, 0xF,
                                              "VRC7 patch number", "%i");
...
unsigned int CInstrumentVRC7::GetPatch() const { return m_iPatch; }
