...
public:
  ...
  LPCTSTR
  GetVKeyName(int virtualKey) const; // Translates virtual key to a string
  void StoreShortcut(int Item, int Key,
                     int Mod); // Store key and modifier for shortcut
...
public:
  ...
  static const std::vector<stAccelEntry>
      DEFAULT_TABLE;                // // // List of default shortcuts
