...
void CSimpleFile::WriteChar(char Value) { Write(&Value, sizeof(char)); }

void CSimpleFile::WriteShort(short Value) { Write(&Value, sizeof(short)); }

void CSimpleFile::WriteInt(int Value) { Write(&Value, sizeof(int)); }
