...
/*!
        \brief A class which represents an independent component of the pattern
   editor. This class handles several mouse events while the drawing takes place
   in the new CPatternEditor class in 0.5.0 beta.
*/
...
public:
  ...
  /*!	\brief Checks whether the component contains a given point.
          \return True if the point lies within the rectangle defined by this
     component. \param point A point struct. */
