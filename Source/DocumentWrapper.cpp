...
CFamiTrackerDocWrapper::CFamiTrackerDocWrapper(CFamiTrackerDoc *pDocument,
                                               int iTrack)
    : m_pDocument(pDocument), m_iTrack(iTrack) {}

void CFamiTrackerDocWrapper::GetNoteData(unsigned int Frame,
...
CSequenceInterface const *
CFamiTrackerDocWrapper::GetSequence(unsigned int Index, int Type) const {
...
CInstrument2A03Interface const *
CFamiTrackerDocWrapper::Get2A03Instrument(int Instrument) const {
  return std::dynamic_pointer_cast<const CInstrument2A03Interface>(
             m_pDocument->GetInstrument(Instrument))
      .get();
}

CSeqInstrumentInterface const *
CFamiTrackerDocWrapper::GetSeqInstrument(int Instrument) const // // //
{
  return std::dynamic_pointer_cast<const CSeqInstrumentInterface>(
             m_pDocument->GetInstrument(Instrument))
      .get();
}

unsigned int CFamiTrackerDocWrapper::GetNoteEffectType(unsigned int Frame,
...
unsigned int CFamiTrackerDocWrapper::GetNoteEffectParam(unsigned int Frame,
                                                        unsigned int Channel,
                                                        unsigned int Row,
                                                        int Index) const {
  stChanNote Note;
...
void CFamiTrackerDocWrapper::GetSampleName(unsigned int Index,
                                           char *Name) const {
...
char CFamiTrackerDocWrapper::GetSampleData(unsigned int Sample,
