...
ON_NOTIFY(NM_CLICK, IDC_SAMPLE_LIST,
          &CInstrumentEditorDPCM::OnNMClickSampleList)
ON_NOTIFY(NM_CLICK, IDC_TABLE, &CInstrumentEditorDPCM::OnNMClickTable)
ON_NOTIFY(NM_DBLCLK, IDC_SAMPLE_LIST,
          &CInstrumentEditorDPCM::OnNMDblclkSampleList)
ON_NOTIFY(NM_RCLICK, IDC_SAMPLE_LIST,
          &CInstrumentEditorDPCM::OnNMRClickSampleList)
...
ON_NOTIFY(UDN_DELTAPOS, IDC_DELTA_SPIN,
          &CInstrumentEditorDPCM::OnDeltaposDeltaSpin)
...
void CInstrumentEditorDPCM::OnNMClickTable(NMHDR *pNMHDR, LRESULT *pResult) {
  ...
  Text.Format(
      _T("%02i - %s"), Sample,
      pTableListCtrl->GetItemText(pTableListCtrl->GetSelectionMark(), 2));
