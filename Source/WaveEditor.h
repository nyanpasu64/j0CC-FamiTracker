...
public:
  CWaveEditorFDS(int sx, int sy, int lx, int ly)
      : CWaveEditor(sx, sy, lx, ly), m_pInstrument(NULL){};
...
public:
  CWaveEditorN163(int sx, int sy, int lx, int ly)
      : CWaveEditor(sx, sy, lx, ly), m_pInstrument(NULL), m_iWaveIndex(0){};
