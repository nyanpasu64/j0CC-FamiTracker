...
public:
  HistoryFileDlg(PATHS historyType,
                 ...
                 LPCTSTR defaultExt = NULL, LPCTSTR defaultName = NULL,
...
// void fileDialog(CFamiTrackerApp theApp, CString & fileName, UINT idTitle,
// DWORD flags, BOOL openNotSave, PATHS pathType);
