...
// parallel arrays are evil. burn this with fire. each config option must be
// added to:
...
const CString CConfigGeneral::CONFIG_DESC[] = {
    ...
    _T("Check for new " APP_NAME
       " versions on startup if an internet connection could be established."),
};
